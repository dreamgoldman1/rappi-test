...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'gol_api.api_json' => 'getGolApi_ApiJsonService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('IcJMmK3Wgy', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('obPQmcA-JZ', 0, 'ECj+IIsfFXsPMO8Lcp+BqM', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_77890e21e60296df6dfb8a0391ee0cc0147f91f4b87edbf89e3f35d8c1eb1a27');
    ...
    /**
     * Gets the 'gol_api.api_json' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \GOL\ApiBundle\Controller\ApiController A GOL\ApiBundle\Controller\ApiController instance
     */
    protected function getGolApi_ApiJsonService()
    {
        return $this->services['gol_api.api_json'] = new \GOL\ApiBundle\Controller\ApiController();
    }
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('407wyaLxI3', NULL, 'ECj+IIsfFXsPMO8Lcp+BqM', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/GOL/HeaderBundle/Resources/views'), 'GOLHeader');
        $instance->addPath(($this->targetDirs[3].'/src/GOL/SidebarBundle/Resources/views'), 'GOLSidebar');
        $instance->addPath(($this->targetDirs[3].'/src/GOL/FooterBundle/Resources/views'), 'GOLFooter');
        $instance->addPath(($this->targetDirs[3].'/src/GOL/ContentBundle/Resources/views'), 'GOLContent');
        $instance->addPath(($this->targetDirs[3].'/src/GOL/ApiBundle/Resources/views'), 'GOLApi');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('b02b3714d29fa4686ca8645febb615384c7f7e74');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sOgR2AAe7A', 0, 'ECj+IIsfFXsPMO8Lcp+BqM', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58a73e125a3d27.31873686')), true);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'GOLHeaderBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GOL/HeaderBundle'),
                    'namespace' => 'GOL\\HeaderBundle',
                ),
                'GOLSidebarBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GOL/SidebarBundle'),
                    'namespace' => 'GOL\\SidebarBundle',
                ),
                'GOLFooterBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GOL/FooterBundle'),
                    'namespace' => 'GOL\\FooterBundle',
                ),
                'GOLContentBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GOL/ContentBundle'),
                    'namespace' => 'GOL\\ContentBundle',
                ),
                'GOLApiBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GOL/ApiBundle'),
                    'namespace' => 'GOL\\ApiBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'GOLHeaderBundle' => 'GOL\\HeaderBundle\\GOLHeaderBundle',
                'GOLSidebarBundle' => 'GOL\\SidebarBundle\\GOLSidebarBundle',
                'GOLFooterBundle' => 'GOL\\FooterBundle\\GOLFooterBundle',
                'GOLContentBundle' => 'GOL\\ContentBundle\\GOLContentBundle',
                'GOLApiBundle' => 'GOL\\ApiBundle\\GOLApiBundle',
            ...
            'secret' => 'b02b3714d29fa4686ca8645febb615384c7f7e74',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'b02b3714d29fa4686ca8645febb615384c7f7e74',
